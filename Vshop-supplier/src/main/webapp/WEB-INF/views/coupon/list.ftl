	...
	<div class="right-content">
		<div class="path">
			<div>
				<a href="${base}">供应商中心</a> 
				<span>&gt;</span> 
				<a href="#?act=store&amp;op=store_coupon"> 优惠券管理 </a>
				<span>&gt;</span>优惠券列表
			</div>
		</div>
		<div class="main">
			...
			<div class="wrap">
				...
				<form method="get" action="${base}/coupon/list" target="_self" id="queryForm">
			...
			<script>
				...
				function editCoupon(id) {
				   	layer.open({
					    ...
					    skin: 'layui-layer-rim',
					    title: '修改优惠券',
					    content :  ['${base}/coupon/edit?id=' + id, 'no'],
					    success: function(layero, index){
					    }
					});
				}
