package com.Vshop.front.pay.mobile.wxpay.util;
...
public class SignUtils {
	...
	private String genProductArgs(Pay order , boolean isTopUp) {
		try {
			...
			// 课程名称
			String goodsDetail =new String(( isTopUp ? "pinGo pay" : WXpayConfig.GOODSDETAIL).getBytes());// 课程描述
