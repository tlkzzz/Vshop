package com.Vshop.front.wechat.menu;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.Vshop.front.wechat.pojo.AccessToken;
import com.Vshop.front.wechat.pojo.Button;
import com.Vshop.front.wechat.pojo.CommonButton;
import com.Vshop.front.wechat.pojo.ComplexButton;
import com.Vshop.front.wechat.pojo.Menu;
...
public class MenuManager {  
    ...
    public static void main(String[] args) {  
        // 第三方用户唯一凭证  
        String appId = "wx2a29d7c7b3575fc6";  
        // 第三方用户唯一凭证密钥  
        String appSecret = "f2cedc8e317d2b16074c5c99371d4f42";  
...
//                log.info("菜单删除失败！");
    ...
    private static Menu getMenu() {  
        ...
        btn11.setType("view");  
        btn11.setKey("11");  
        btn11.setUrl("http://b2b2c.Vshop.net/Vshop-front/m/index/index");
  
        CommonButton btn12 = new CommonButton();  
        btn12.setName("品牌街");  
        btn12.setType("view");  
        btn12.setKey("12");  
        btn12.setUrl("http://b2b2c.Vshop.net/Vshop-front/m/brand/brand");
  
        CommonButton btn13 = new CommonButton();  
        btn13.setName("商城类目");  
        btn13.setType("view");  
        btn13.setKey("13"); 
        btn13.setUrl("http://b2b2c.Vshop.net/Vshop-front/m/category/category");   
  
        CommonButton btn14 = new CommonButton();  
        btn14.setName("个人中心");  
        btn14.setType("click");  
        btn14.setKey("14"); 
        btn13.setUrl("http://b2b2c.Vshop.net/Vshop-front/m/buyer/center"); 
...
//        mainBtn1.setKey("1");   
        //mainBtn1.setUrl("http://b2b2c.Vshop.net/Vshop-front/m/index/index");
