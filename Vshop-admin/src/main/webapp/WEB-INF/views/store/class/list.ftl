        ...
        <table class="table tb-type2 nobdb">
            ...
            <#list list as c>
                <tr class="hover edit">
                    ...
                    <td class="w48 sort"><span title="可编辑" datatype="number" modUrl="${base}/store/classs/modifySort"
                                               fieldid="${c.id}" fieldname="sort" nc_type="inline_edit" class="editable">${c.sort}</span></td>
                    <td class="name">
                        <span title="分类名称" required="1" fieldid="${c.id}"  modUrl="${base}/store/classs/modifyName"
                    ...
                    <td class="w84"><span><a href="${base}/store/classs/updateIndex?id=${c.id}">编辑</a> | <a href="JavaScript:void(0);"onclick="delClassid('${c.id}')">删除</a> </span></td>
                </tr>
            </#list>
            </tbody>
            <tfoot>
