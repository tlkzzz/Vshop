...
<div class="layout">
  ...
  <div class="right-content">
       <div class="path">
       <div>    <a href="#">供应商中心</a> <span>></span>
                <a href="#"/>供应商分类管理 </a><span>></span>分类   
...
<div class="wrap">
  <div class="tabmenu">
    <ul class="tab pngFix">
  <li class="active"><a  href="#?act=store&op=store_goods_class">供应商分类</a></li></ul>
  ...
  <table class="ncu-table-style" id="my_category" server="#?act=store&op=goods_class_ajax" >
        <thead>
			    ...
			    function addStoreclass1(stclassid){
			         layer.open({
			            ...
			            yes: function (index) {
			                ...
			                if(""==stcName){
			                	layer.getChildFrame('#vat_stcName').html('供应商分类名不能为空');
			                	return false;
			                }
							if(""==stcSort){
								layer.getChildFrame('#vat_stcSort').html('供应商排序不能为空');
								return false;
			                }
			            ...
			            yes: function (index) {
			                ...
			                var stcId="";
			                 $.ajax({
			                    ...
			                    success:function(data){
			                        if(data.success){
			                             layer.msg('编辑成功', {icon: 1},initDataList());
			                        }else{
                ...
                success:function(data) {
                    if(data){
                         if(sdf.attr("class")=='noshowclass-ico-btn'){
				              ...
				              obj.attr("pstate","false");
				            }else{
				              sdf.attr("class","noshowclass-ico-btn");
				              obj.attr("pstate","true");
				            }
                    }else{
