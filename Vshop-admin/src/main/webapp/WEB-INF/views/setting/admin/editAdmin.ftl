  ...
  <form id="add_form" method="post" action="${base}/setting/admin/saveOrUpdate">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="adminSupplierId">供应商:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
          	<select name="supplierId">
                 ...
                 <#list supplierList as supplier>
                    <option value="${supplier.id}" <#if supplier.id==admin.supplierId>selected="selected"</#if>>${supplier.name}</option>
                 </#list>
            </select>
          </td>
          <td class="vatop tips">请选择一个供应商</td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
