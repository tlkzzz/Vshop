...
<script type="text/javascript">
    function deleteGoods(){
        ...
        if (items==0) {
            ...
            if(confirm('您确定要删除吗?')){
                $("#formSearch").attr("action",APP_BASE+"/coupon/delete");
                $('#formSearch').submit();
            }
        }
    }
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="${base}/coupon/add" ><span>新增</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <form method='post' id="formSearch" name="formSearch" action="${base}/coupon/list">
        ...
        <table class="table tb-type2">
            ...
            <#list datas as data>
            <tr class="hover edit">
                <td><input type="checkbox" name="ids" value="${data.couponId}" class="checkitem"></td>
                <td >${data.couponPic}</td>
