...
<div class="layout">
    ...
    <div class="wrap-shadow">
        <div class="wrap-all">
            <div class="chart">
                <div class="pos_x1 bg_a1" title="请选择供应商分类"></div>
                <div class="pos_x2 bg_b2" title="填写供应商信息"></div>
            ...
            <div class="ncu-form-style grade-shop">
                <form method="post" enctype="multipart/form-data" id="apply_form" action="">
                    ...
                    <dl>
                        <dt class="required"><em class="pngFix"></em>销售渠道名称：</dt>
                        <dd>
                            <p>
                    ...
                    <dl>
                        <dt class="required"><em class="pngFix"></em>销售渠道分类：</dt>
                        <dd>
                        	<p>
                        		<input id="stId" type="hidden" name="stId" value="" validate="required:true" min="1">
							    <span></span>
                        	</p>
                        	<span id="stIdList">
                    ...
                    <dl>
                        ...
                        <dd>
                             <p>
	                            <input type="text" class="text w200" name="contacter"/>
	                            <span></span>
	                         </p>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd>
                            <p>
                                <input type="text" class="text w200" name="mobile" maxlength="20" />
                                <span></span></p>
                        </dd>
                    </dl>
                    <dl>
                        <dt class="required"><em class="pngFix"></em>固定电话：</dt>
                        <dd>
                            <p>
                    ...
                    <dl>
                        ...
                        <dd>
                            <p>
                                <input type="text" class="text w200" name="fax" maxlength="20" />
                                <span></span></p>
                        </dd>
                    </dl>
                    <dl>
                    ...
                    <dl>
                        <dt><em class="pngFix"></em>上传联系人身份证：</dt>
                        <dd>
                             <p>
	                              <div class="banner">
                    ...
                    <dl>
                        ...
                        <dd>
                             <p>
	                            <input type="text" class="text w200" name="legaler"/>
	                            <span></span>
	                         </p>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd>
                             <p>
	                            <input type="text" class="text w200" name="legalerId"/>
	                            <span></span>
	                         </p>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd>
                             <p>
                              <div class="banner">
                                  <img alt="" id="legalerPurlImage" src="" style="width:150px;height: 160px;">
                                  <a href="javascript:void(0);" class="btn-upload btng-s">
                                      <div id="result_banner"></div>
                                      <input type="file" id="legalerImage" name="files" class="file" onChange="ajaxFileUploads('legalerImage','legalerPurlImage','legalerPurl');"/>
                                  	  <input type="hidden" class="text w200" name="legalerPurl" id="legalerPurl"/>
                                  </a>
                                  <p class="hint">支持格式jpg,jpeg,png,gif，请保证图片清晰且文件大小不超过400KB</p>
                              </div>
                             </p> 
                    ...
                    <dl>
                        ...
                        <dd>
                             <p>
	                            <input type="text" class="text w200" name="busLicenseNo"/>
	                            <span></span>
	                         </p>
                        </dd>
                    </dl>
                    ...
                    <dl>
                        ...
                        <dd>
                             <p>
	                            <input type="text" class="text w200" name="dishuiRegistNo"/>
	                            <span></span>
	                         </p>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd>
                            <p>
                                 <input type="hidden" class="text w200" name="dishuiRegistPurl" id="dishuiRegistPurl"/>
	                             <span></span>
	                             <div class="banner">
	                                    <img alt="" id="dishuiRegistImage" src="" style="width:150px;height: 160px;">
	                                    <a href="javascript:void(0);" class="btn-upload btng-s">
	                                        <div id="result_banner"></div>
                    ...
                    <dl>
                        ...
                        <dd>
                             <p>
	                            <input type="text" class="text w200" name="guoshuiRegistNo"/>
	                            <span></span>
	                         </p>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd>
                            <p>
                                 <input type="hidden" class="text w200" name="guoshuiRegistPurl" id="guoshuiRegistPurl"/>
	                             <span></span>
	                             <div class="banner">
	                                    <img alt="" id="guoshuiRegistPurlImage" src="" style="width:150px;height: 160px;">
	                                    <a href="javascript:void(0);" class="btn-upload btng-s">
	                                        <div id="result_banner"></div>
                    ...
                    <dl>
                        ...
                        <dd>
                             <p>
	                            <input type="text" class="text w200" name="accountBank"/>
	                            <span></span>
	                         </p>
                        </dd>
                    </dl>
