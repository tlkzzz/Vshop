...
<div class="eject_con" style="width:500px;">
	...
	<form method="post" action="#" id="coupon_form">
		...
		<dl>
			...
			<dd>
				<input class="text w50 mr5" name="couponLimit" value="${coupon.couponLimit}" type="text" >
			</dd>
		</dl>
		<dl>
			<dt class="required">
			...
			<dd>
				<input class="text w50 mr5" name="couponPrice" value="${coupon.couponPrice}" type="text">
			</dd>
		</dl>
		<dl>
			<dt class="required">
		...
		<dl>
			...
			<dd>
				<input class="text w50 mr5" name="couponstorage" value="${coupon.couponstorage}" type="text">
			</dd>
		</dl>
