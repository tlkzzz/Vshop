				...
				<div class="templet">
					<div class="nonce">
					    <#if store.storeTheme!=null && store.storeTheme>
					       <img src="${base}/res/css/style/${store.storeTheme}/images/preview.jpg" style="width: 200px;height: 200px;" id="current_theme_img"/>
					    <#else>
					      <img src="${base}/res/css/style/default/images/preview.jpg" style="width: 200px;height: 200px;" id="current_theme_img"/>
					    </#if>
					</div>
					<div class="txt">
						<p>
							店铺名称：<span>${store.storeName}</span><a href="${frontServer}/store/shop?storeId=${store.storeId}"
								target="_blank" class="btn">店铺首页</a>
						</p>
						<p>
							店铺模版名称：<b id="current_template">${store.storeTheme}</b>
						</p>
						<p>
							店铺风格名称：<b id="current_style">纯色简约线条</b>
						</p>
						<p>
							<b id="store_style"></b>
						</p>
