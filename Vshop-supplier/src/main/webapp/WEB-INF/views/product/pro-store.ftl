  ...
  <table id="my_goods" server="" class="ncu-table-style">
    <thead>
      <tr nc_type="table_header">
         <!--<th class="w30"></th>
        <th class="w70"></th>-->
        <th class="" coltype="editable" column="goods_name" checker="check_required" inputwidth="230px" colspan="3" style="text-align:left;padding-left:13%;">商品名称&nbsp;/&nbsp;类型</th>
        <!-- <th class="w180" coltype="switchable" column="goods_show" onclass="right_ico" offclass="wrong_ico">上架</th> -->
        <!-- <th  class="w100" coltype="editable" column="supplier_name" checker="check_number" inputwidth="50px">机构名称</th> -->
        <th  class="w100" coltype="editable" column="supplier_name" checker="check_number" inputwidth="50px">商品价格</th>
        <th  class="w100" coltype="editable" column="supplier_name" checker="check_number" inputwidth="50px">库存</th>
        <th  class="w100" coltype="editable" column="goods_store_price" checker="check_number" inputwidth="50px">下架时间</th>
