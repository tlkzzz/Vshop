...
<div class="layout">
    ...
    <div class="wrap-shadow">
        <div class="wrap-all">
            <div class="chart">
                <div class="pos_x1 bg_a1" title="请选择商家分类"></div>
                <div class="pos_x2 bg_b2" title="填写院长和商家信息"></div>
            ...
            <div class="ncu-form-style grade-shop">
                <form method="post" enctype="multipart/form-data" id="apply_form" action="">
                    ...
                    <dl>
                        <dt class="required"><em class="pngFix"></em>商家名称：</dt>
                        <dd>
                            <p>
                    ...
                    <dl>
                        ...
                        <dd>
                                ...
                                <select name="scId"  name="scId" validate="required:true" min="1">
                    ...
                    <dl class="bottom">
                        ...
                        <dd>
                            <p class="mb10">
                                ...
                                <label for="notice">我已认真阅读并同意<a href="#?act=document&code=open_store" target="_blank">商家协议</a>中的所有条款</label>
                                <span></span> </p>
                            <p class="mb10">
                               <#-- <input type="submit" class="submit" value="商家设立" />-->
...
<!--         </p> -->
        Copyright 2016-2017 磁石世纪（北京）投资管理有限公司 版权所有  京ICP备12042458号-3.
<!--         &nbsp;&nbsp; -->
<!--         ICP证： -->
        <br/>
