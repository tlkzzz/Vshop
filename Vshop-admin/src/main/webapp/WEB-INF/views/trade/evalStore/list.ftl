...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>评价管理</h3>
            <ul class="tab-base">
                <li><a href="${base}/trade/evalGoods/list" ><span>来自会员的评价</span></a></li>
                <li><a href="JavaScript:void(0);" class="current"><span>商家动态评价</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <form method="post" name="formSearch" action="${base}/trade/evalStore/list">
        ...
        <table class="tb-type1 noborder search">
            <tbody>
            <tr>
                <th><label for="sevalStoreName">商家名称</label></th>
    ...
    <table class="table tb-type2" id="prompt">
        ...
        <tr>
            <td><ul>
                <li>会员可在订单完成后对商家进行动态评价操作</li>
                <li>评价统计信息将显示在对应的商家相应页面</li>
            </ul></td>
        </tr>
        </tbody>
    </table>
