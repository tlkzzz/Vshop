...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="${base}/store/manager/auditList" ><span>商家设立</span></a></li>
    ...
    <form id="store_form" method="post" action="${base}/store/manager/updateDetail">
        ...
        <table class="table tb-type2">
            <tbody>
            <tr class="noborder">
                <td colspan="2" class="required"><label>院长账号:</label></td>
            </tr>
            <tr class="noborder">
           ...
           <tr class="noborder">
            ...
            <tr class="noborder">
	            <td class="vatop rowform" rowspan="4">
		            <label for="store_state0"><span>关闭</span></label>
	                <input id="store_state0" type="radio" value="0" name="storeState" <#if storeDetail.storeState == 0>checked="checked"</#if>>&nbsp;&nbsp;
	                <label for="store_state2"><span>审核</span></label>
	                <input id="store_state2" type="radio" value="2" name="storeState" <#if storeDetail.storeState == 2>checked="checked"</#if>>&nbsp;&nbsp;
	                <label for="store_state1"><span>通过</span></label>
	                <input id="store_state1" type="radio" value="1" name="storeState" <#if storeDetail.storeState == 1>checked="checked"</#if> disabled="disabled">&nbsp;&nbsp;
	                <label for="store_state3"><span>审核未过</span></label>
	                <input id="store_state3" type="radio" value="3" name="storeState" <#if storeDetail.storeState == 3>checked="checked"</#if> disabled="disabled">
	            </td>
		          <#--  
