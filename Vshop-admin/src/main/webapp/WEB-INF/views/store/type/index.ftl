	...
	<div class="iframebox">
		<div class="cont-tit">
			...
			<li style="margin-right: 20px">
				...
				<li>
					<a href="${base}/store/type/index" class="current"><span style="color:#F0F;background-position: 100% -240px;">管理&nbsp;</span></a>
				</li>
				<li>
					<a href="javascript:opertest(0)" class="current"><span>新增一级分类&nbsp;</span></a>
				</li>
				<li>
					<a href="JavaScript:goto(0);" class="current"><span>导入(未完成)&nbsp;</span></a>
				</li>
				<li>
...
<script type="text/javascript">
	...
	function initDataList(parentId){
		...
		$.ajax({
            async:false,
            url:"${base}/store/type/list",//默认加载list 页面
            data:{div:div},
	...
	function opertest(id){
		var url = "${base}/store/type/addIndex?Id="+id;
		frameOperate.prepareUpdate('update','添加/修改',url,840,400,false);
	}
	
	/*修改内容*/
	function update(id){
		var url = "${base}/store/type/updateIndex?Id="+id;
		frameOperate.prepareUpdate('update','添加/修改',url,840,400,false);
	}
