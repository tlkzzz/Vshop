...
<div class="fixed-bar">
    <div class="item-title">
        ...
        <ul class="tab-base">
            ...
            <li><a href="JavaScript:void(0);" class="current"><span>查看商家</span></a></li>
        </ul>
    </div>
</div>
...
<form id="form_store_verify" action="${base}/store/manager/verify" method="post">
   <#-- <input id="verify_type" name="verifyType" type="hidden" value="3"/>-->
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        <thead>
        <tr>
            <th colspan="20">商家经营信息</th>
        </tr>
        </thead>
        <tbody>
       <#--  <tr>
            <th class="w150">商家帐号：</th>
        ...
        <tbody>
	        <tr>
	            ...
	            <td class="vatop rowform onoff" rowspan="4">
		                ...
		                <input id="store_state0" name="storeState" onclick="$('#nopass2').show();" value="3" type="radio"/>
	            </td>
	        </tr>
