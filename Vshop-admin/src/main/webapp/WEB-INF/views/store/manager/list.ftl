...
<div class="page">
    ...
    <form method="post" name="formSearch" id="formSearch" action="${base}/store/manager/list">
        ...
        <table class="tb-type1 noborder search">
            ...
            <tr>
                ...
                <th><label for="sellerName">分销商账号</label></th>
    ...
    <table class="table tb-type2" id="prompt">
        ...
        <tr>
            <td><ul>
                <li>如果当前时间超过商家有效期或商家处于关闭状态，前台将不能继续浏览该商家，但是院长仍然可以编辑该商家</li>
            </ul></td>
        </tr>
        </tbody>
    </table>
        ...
        <table class="table tb-type2">
            ...
            <tr>
                ...
                <td class="align-center w120">
                    ...
                    &nbsp;&nbsp;<a href="${base}/report/balanceIndex?storeId=${store.storeId}">查看结算情况</a>&nbsp;&nbsp;
                   <#-- <#if store.storeId != 1>
