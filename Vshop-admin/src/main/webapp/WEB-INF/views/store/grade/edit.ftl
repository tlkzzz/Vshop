...
<div class="page">
    ...
    <form id="grade_form" method="post" action="${base}/store/grade/edit">
        ...
        <table class="table tb-type2 nobdb">
            ...
            <#--<tr>-->
            <#--<td colspan="2" class="required"><label for="skin_limit">可选模板套数:</label></td>-->
            <#--</tr>-->
            <#--<tr class="noborder">-->
            <#--<td class="vatop rowform">${grade.sgTemplateNumber} <span class="grey">(在商家等级列表设置)</span></td>-->
            <#--<td class="vatop tips"></td>-->
            <#--</tr>-->
            <#--<tr>-->
            <#--<td colspan="2" class="required"><label for="skin_limit">可用附加功能:</label></td>-->
            <#--</tr>-->
            <#--<tr class="noborder">-->
