 ...
 * 
 */
package com.Vshop.front.pay.mobile.unionpay.config.appConsumeConfig;
...
import com.Vshop.front.pay.mobile.unionpay.config.base.UnionpayBaseConfig;
...
public class AppConsumeConfig extends UnionpayBaseConfig {
	...
	private static AppConsumeConfig loadConfig() {
		// 读取参数
		ResourceBundle rb = ResourceBundle.getBundle("com.Vshop.front.pay.mobile.unionpay.config.appConsumeConfig.appConsumeConfig");
