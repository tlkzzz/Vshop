		            				...
		            				<tr class="bd-line">
		        						<td> 
		        							<#if daddress.isDefault == '1'>
		        								<input type="radio" name="is_default" checked value="${daddress.addressId}"> 默认
		        							<#else>
		        								<input type="radio" name="is_default"  value="${daddress.addressId}"> 默认
		        							</#if>
