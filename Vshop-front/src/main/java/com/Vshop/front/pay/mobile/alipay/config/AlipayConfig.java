package com.Vshop.front.pay.mobile.alipay.config;
...
public class AlipayConfig {
	...
	private static void initAlipayConfig() {
		ResourceBundle rb = ResourceBundle.getBundle("com.Vshop.front.pay.mobile.alipay.config.alipayConfig");
		...
		if(partner.isEmpty()|| private_key.isEmpty() || ali_public_key.isEmpty() ||log_path.isEmpty() || input_charset.isEmpty() || sign_type.isEmpty()) {
			...
			loger.error("请完整设置支付宝支付相关参数参数!(参数设置位置：com.Vshop.pinche.pay.mobile.alipay.config.alipayConfig.properties)" , e);
		}
