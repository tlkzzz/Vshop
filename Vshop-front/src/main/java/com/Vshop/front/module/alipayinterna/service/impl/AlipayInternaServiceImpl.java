package com.Vshop.front.module.alipayinterna.service.impl;
...
import com.Vshop.front.alipayinterna.util.AlipayNotify;
...
public class AlipayInternaServiceImpl implements AlipayInternaService {
	...
	public String toPay(String ordersn) {
		try{ 
			...
			////////////////////////////////////请求参数//////////////////////////////////////
			//Return URL
			String return_url = MemContents.aplipayinternafrontUrl;
			//After the payment transaction is done
			//Notification URL
			String notify_url = MemContents.aplipayinternabackUrl;
