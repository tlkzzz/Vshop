...
//            },
            ...
            goods_commission_rate : {
				required: '佣金比例不能为空',
                number     : '佣金比例只能是数字',
                min		   : '佣金比例必须是0.01~1之间的数字',
                max		   : '佣金比例必须是0.01~1之间的数字'
            },
        }
    });
      ...
      <div class="goods-attribute" style="width: 98%;">
		...
		<dl>
          ...
          <dd>
	          <select name="store_id" id="store">
		          ...
		          <#if stores??>
		          	<#list stores as sts>
		          		<option value="${sts.storeId}">${sts.storeName}</option>
		          	</#list>
		          </#if>
	          </select>
          </dd>
       ...
       <dl>
          ...
          <dd  nc_type="no_spec">
            ...
            <p class="hint">商铺库存数量必须为1~1000000000之间的整数</br>若启用了库存配置，则系统自动计算商品的总数，此处无需商家填写</p>
          </dd>
       </dl>
        <dl>
          ...
          <dd nc_type="no_spec">
            ...
            <p class="hint">商品货号是指商家个人管理商品的编号，会员不可见</br>最多可输入20个字符，支持输入中文、字母、数字、_、/、-和小数点</p>
          </dd>
        </dl>
        <!-- 图片上传 -->
        <dl>
        ...
        <dl>
          ...
          <dd>
          	...
          	<p class="hint">先选择品牌，根据品牌过滤出供应商信息</p>
          </dd>
        </dl>
...
// 					"storeId":storeId,
					...
					"goodsStorePrice": goodsStorePrice,//商品商家价格
					"goodsStorePriceInterval": goodsStorePriceInterval,//区间价格
					"goodsMarketPrice": goodsMarketPrice,//商品商家价格
					...
					"goodsTransfeeCharge": goodsTransfeeCharge,//商品运费承担方式 默认 0为会员承担 1为商家承担
					//"StoreClassId": StoreClassId,//商家自定义分类id
