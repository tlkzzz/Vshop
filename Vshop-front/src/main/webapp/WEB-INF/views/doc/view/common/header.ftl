...
<link rel="shortcut icon" href="${base}/res/doc/image/favicon.ico" />
<link href="${base}/res/doc/css/stylecss.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${base}/res/doc/js/jquery-1.8.3.min.js"></script>
</head>
<body>
	<!--头部-->
	<div id="header">
		<div class="header_top">
			<a href="${base}/doc/view/index">
				<img src="${base}/res/doc/images/logo.png" style="margin-top: 22px;"/>
			</a>
		</div>
	</div>
	<!--头部结束-->
