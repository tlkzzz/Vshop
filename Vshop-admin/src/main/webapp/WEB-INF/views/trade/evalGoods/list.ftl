...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>评价管理</h3>
            <ul class="tab-base">
                <li><a href="JavaScript:void(0);" class="current"><span>来自会员的评价</span></a></li>
               <!--  <li><a href="${base}/trade/evalStore/list" ><span>商家动态评价</span></a></li> -->
            </ul>
        </div>
    </div>
    ...
    <form method="post" name="formSearch" action="${base}/trade/evalGoods/list">
        ...
        <table class="tb-type1 noborder search">
            ...
            <tr>
                ...
                <th><label for="gevalStorename">商家名称</label></th>
    ...
    <table class="table tb-type2">
        ...
        <tr class="thead">
            ...
            <th class="w108 align-center">商家名称</th>
                            ...
                            <ul class="evaluation-pic-list">
                                <#if eval.gevalImage?contains(",")>
                                    <#list eval.gevalImage?split(",") as img>
                                        <li><a nctype="nyroModal"  href="${base}/upload/eval/${img}"> <img src="${base}/upload/eval/${img}"> </a></li>
                                    </#list>
                                <#else>
                                    <li><a nctype="nyroModal"  href="${base}/upload/eval/${eval.gevalImage}"> <img src="${base}/upload/eval/${eval.gevalImage}"> </a></li>
                                </#if>
                            </ul>
                        </div>
                    </#if>
