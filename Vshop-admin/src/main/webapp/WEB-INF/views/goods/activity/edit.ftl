...
<div class="page">
    ...
    <form id="spec_form" method="post" action="${base}/goods/activity/update">
    	<input type="hidden" name="activityId" id="activityId" value="${goodsActivity.activityId}"/>
        <table class="table tb-type2">
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="activityName" id="activityName" value="${goodsActivity.activityName}"/></td>
            ...
            <tr class="noborder">
            	<td>
					<div class="logo clf" > 
                          ...
                          <#if goodsActivity.activityBanner ??&& goodsActivity.activityBanner!=''>
                               <img src="${imgServer}${goodsActivity.activityBanner}" height="100px" id="busLicense" class="img">
                          <#else>
                               <img src="${base}/images/nopic.png" height="100px" id="busLicense" class="img">
                          </#if>
                    </div>
		            <input type="hidden" id="activityBanner" name="activityBanner" value="${goodsActivity.activityBanner}" />
                </td>
            ...
            <tr class="noborder">
                <td class="vatop rowform">
                	<input type="radio" name="activityUse" <#if goodsActivity.activityUse = 1>checked="checked"</#if> value="1" id="activityUse1"/><label for="activityUse1">启用</label>
	                <input type="radio" name="activityUse" <#if goodsActivity.activityUse = 0>checked="checked"</#if> value="0" id="activityUse0"/><label for="activityUse0">停用</label>
	            </td>
                <td class="vatop tips"></td>
            </tr>
            <tr class="noborder">
            ...
            <tr class="noborder">
                <td>
					<div class="logo clf" > 
		                  ...
		                  <#if goodsActivity.activityBanner2 ??&& goodsActivity.activityBanner2!=''>
                               <img src="${imgServer}${goodsActivity.activityBanner2}" height="100px" id="busLicense1" class="img">
                          <#else>
                               <img src="${base}/images/nopic.png" height="100px" id="busLicense1" class="img">
                          </#if>
		            </div>
		            <input type="hidden" id="activityBanner2" name="activityBanner2" value="${goodsActivity.activityBanner2}" />
                </td>
                <td class="vatop tips">支持格式gif,jpg,jpeg,png</td>
            </tr>
