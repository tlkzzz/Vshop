...
<div class="page">
    ...
    <div class="info-panel">
        ...
        <dl class="shop">
            <dt>
            <div class="ico"><i></i><sub title="新增商家数"><span><em id="statistics_store">0</em></span></sub></div>
            <h3>商家</h3>
            <h5>新商家审核</h5>
            </dt>
            <dd>
                <ul>
                    <li class="w33pre none"><a href="${base}/store/manager/auditList">商家审核<sub><em id="statistics_store_joinin">0</em></sub></a></li>
        ...
        <dl class="goods">
            ...
            <dd>
                <ul>
                    ...
                    <li class="w33pre none"><a href="${base}/goods/goodsCommon/list">商品下架<sub><em id="statistics_product_down">0</em></sub></a></li>
                    <li class="w34pre none"><a href="${base}/goods/goodsCommon/list">品牌申请<sub><em id="statistics_brand_apply">0</em></sub></a></li>
                </ul>
            </dd>
        </dl>
        <div class=" clear"></div>
