...
public class AdminAction {
	...
	public String add(Model model){
		try {
			...
			List<Supplier> supplierList = supplierService.findList();
			model.addAttribute("rolelist",rolelist).addAttribute("supplierList", supplierList);
	...
	public String saveOrUpdate(
		...
		if (admin.getAdminId() == null) {
			...
			if (dbAdmin == null) {
				...
				dbAdmin.setSupplierId(admin.getSupplierId());
