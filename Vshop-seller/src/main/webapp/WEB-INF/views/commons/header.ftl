...
<head>
    ...
    <script type="text/javascript" src="${base}/res/js/common/avalon.min.js"></script>
    <!--[if IE]>
...
<!--  
        <div class="quick-menu">
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        ...
                        <li><a href="#?act=member_favorites&op=fslist" target="_top" title="收藏的商家" >收藏的商家</a></li>
                    </ul>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        <li><a target="_blank" href="${frontServer }">商家首页</a></li>
                    </ul>
                </dd>
            </dl>
        </div>
...
<!-- PublicHeadLayout Begin --><div id="header">
    <h1 title="商品汇平台">
    	<a href="${sellerServer }">
    		<img src="${imgOssServer}${siteSet.siteLogo2}" alt="商品汇平台s" class="pngFix" style="max-height: 60px; max-width: 300px;">
    	</a>
   		<i>商家中心</i>
    </h1>
   <!--  <div id="search" class="search">
        <div class="details" id="details">
            <ul class="tab">
                ...
                <li  searchModel="storeSearch" act="storeSearch"><span>商家</span></li>
            </ul>
