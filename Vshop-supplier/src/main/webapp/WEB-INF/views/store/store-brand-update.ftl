...
<div class="eject_con">
    <form method="post" target="_parent" action="" enctype="multipart/form-data" id="brand_apply_form">
      ...
      <input type="hidden" name="brandId" value="${brand.brandId}" id="brandId">
      <dl>
        <dt class="required"><em class="pngFix"></em>品牌名称：</dt>
        <dd>
          <input type="text" class="text" name="brandName" value="${brand.brandName}" id="brand_name" onblur="check_Invoice('brandName', this.value)" fld="strs">
      ...
      <dl>
        <dt>品牌类别：</dt>
        <dd id="gcategory">
                    <input type="hidden" value="" name="classId" id="classId" class="mls_id">
                    <input type="hidden" value="${brand.brandClass}" name="brandClass" id="brandClass" class="mls_name" fld="strs">
      ...
      <dl>
        ...
        <dd>
            <input type="hidden" id="brandPic" name="brandPic" value="${brand.brandPic}"  fld="strs"/>
            <p><span class="sign"><img src="${imgServer}${brand.brandPic}" id="storeband" nc_type="logo1" width="88" height="44"></span></p>
            <p><input type="file" maxlength="0" hidefocus="true" nc_type="logo" name="files" id="brand_pic" onChange="ajaxFileUploads('brand_pic','storeband','brandPic');"></p>
