package com.Vshop.front.pay.mobile.alipay.util;
...
import com.Vshop.front.pay.mobile.alipay.sign.Base64;
...
public class SignUtils {
	...
	public static String signOrderInfo(Pay order , boolean isTopUp) throws UnsupportedEncodingException {
		...
		String goodsName = new String((isTopUp ? "余额充值" : AlipayConfig.GOODSNAME).getBytes("ISO8859-1") , "UTF-8");// 课程名称
		String goodsDetail = new String((isTopUp ? "余额充值" : AlipayConfig.GOODSDETAIL).getBytes("ISO8859-1") , "UTF-8");// 课程描述
