...
<div class="iframebox">
    ...
    <ul class="cont-tab">
        <li ><a href="${base}/trade/evalGoods/index">来自会员的评价</a></li>
        <li class="cur"><a href="${base}/trade/evalStore/index">商家动态评价</a></li>
    </ul>

    <div class="control-mod" >
        <form  method="post" name="queryListForm">
            <input type="text" name="sevalStoreName" class="text" placeholder="商家名称"/>
