...
<div class="fixed-bar">
    <div class="item-title">
        ...
        <ul class="tab-base">
            ...
            <li><a href="${base}/adv/add?apId=0"  ><span>新增</span></a></li>
        ...
        <tbody>
	      ...
	      <tr>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" class="txt Wdate" value="${adv.startDateStr}" name="startTime" id="startTime"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" ></td>
	           <td class="vatop tips"></td>
	        </tr>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
	            	<input type="text" class="txt Wdate" name="endTime" id="endTime" value="${adv.endDateStr}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});">
	            </td>
	            <td class="vatop tips"></td>
	        </tr>
