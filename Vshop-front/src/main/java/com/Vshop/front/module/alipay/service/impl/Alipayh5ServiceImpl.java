...
import com.Vshop.front.module.alipay.service.Alipayh5Service;
import com.Vshop.front.pay.h5.aplipay.config.AlipayConfig;
import com.Vshop.front.pay.h5.aplipay.util.AlipayNotify;
import com.Vshop.front.pay.h5.aplipay.util.AlipaySubmit;
...
public class Alipayh5ServiceImpl implements Alipayh5Service {
	...
	public String toPay(String orderSn) {
		...
		// 必填，不能修改
		// 服务器异步通知页面路径
		String notify_url = MemContents.alipayh5backUrl;
		// 需http://格式的完整路径，不能加?id=123这类自定义参数
		// 页面跳转同步通知页面路径
		String return_url = MemContents.alipayh5frontUrl;
		...
		// 必填
		// 付款金额
		String total_fee = pay.getPayAmount() + "";
		// 必填
		// 课程展示地址
		String show_url = "http://b2b2c.Vshop.com/Vshop-front/m/goods/goodsdetail?id=34";
