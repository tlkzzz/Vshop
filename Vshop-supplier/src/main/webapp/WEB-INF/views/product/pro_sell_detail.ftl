    ...
    <form method="post" id="goods_form" action="#">
      ...
      <div class="goods-attribute">
        ...
        <dl>
          <dt>商品分类：</dt>
          <dd id="gcategory">
                        <span class="f_l">${catename}</span> <a class="edit_gcategory ncu-btn1 ml10" href="${base}/pro/sell"><span>编辑</span></a>
        ...
        <dl>
          ...
          <dd nc_type="no_spec">
            ...
            <p class="hint">商品价格必须是0.01~1000000之间的数字</br>若启用了库存配置，请在下方商品库存区域进行管理</br>商品规格库存表中如有价格差异，供应商价格显示为价格区间形式</p>
          </dd>
        </dl>
         ...
         <dl>
           ...
           <dd nc_type="no_spec">
             ...
             <p class="hint">市场价必须是0.01~1000000之间的数字</br>若启用了库存配置，请在下方商品库存区域进行管理</br>商品规格库存表中如有价格差异，商家价格显示为价格区间形式</p> 
           </dd>
         </dl>
...
<!--               价格区间  -->
<!--             </p> -->
<!--             <p class="hint">成本价必须是0.01~1000000之间的数字</br>若启用了库存配置，请在下方商品库存区域进行管理</br>商品规格库存表中如有价格差异，商家价格显示为价格区间形式</p> -->
<!--           </dd> -->
<!--         </dl> -->
       ...
       <dl>
          ...
          <dd  nc_type="no_spec">
            ...
            <p class="hint">商铺库存数量必须为1~1000000000之间的整数</br>若启用了库存配置，则系统自动计算商品的总数，此处无需供应商填写</p>
          </dd>
       </dl>
        <dl>
          ...
          <dd nc_type="no_spec">
            ...
            <p class="hint">商品货号是指供应商个人管理商品的编号，会员不可见</br>最多可输入20个字符，支持输入中文、字母、数字、_、/、-和小数点</p>
          </dd>
        </dl>
       ...
       <!--  <dl>
          ...
          <dd>
            <div class="pic_list">
              <ul id="menu" class="menu">
                ...
                <li id='li_2'><a class="goods_demo" id="goods_demo" href="#?act=store_album&op=pic_list&item=goods">从用户相册选择</a></li>
              </ul>
              <div class="content">
                <div id="demo"></div>
                <div class="standard">
                  <div>
                    <ul>
                    <li>
                    	<img src="" height="60px" width="60px" nctype="file_0" name="goodsImage" imageSrc="" imageName="" />
						<input type="file" id="myBlogImage0" name="files" multiple="multiple" onChange="ajaxFileUploads('myBlogImage0',this,'file_0','goods');" />
	                </li>
	                 <li>
                    	<img src="" height="60px" width="60px" nctype="file_1" name="goodsImage" imageSrc="" imageName="" />
						<input type="file" id="myBlogImage1" name="files" multiple="multiple" onChange="ajaxFileUploads('myBlogImage1',this,'file_1','goods');" />
	                </li>
	                 <li>
                    	<img src="" height="60px" width="60px" nctype="file_2" name="goodsImage" imageSrc="" imageName="" />
						<input type="file" id="myBlogImage2" name="files" multiple="multiple" onChange="ajaxFileUploads('myBlogImage2',this,'file_2','goods');" />
	                </li>
	                 <li>
                    	<img src="" height="60px" width="60px" nctype="file_3" name="goodsImage" imageSrc="" imageName="" />
						<input type="file" id="myBlogImage3" name="files" multiple="multiple" onChange="ajaxFileUploads('myBlogImage3',this,'file_3','goods');" />
	                </li>
	                 <li>
                    	<img src="" height="60px" width="60px" nctype="file_4" name="goodsImage" imageSrc="" imageName="" />
						<input type="file" id="myBlogImage4" name="files" multiple="multiple" onChange="ajaxFileUploads('myBlogImage4',this,'file_4','goods');" />
	                </li>
                    </ul>
                  </div>
                  <div class="help">
                    <p class="ico">最多可发布5张商品图片。</p>
                    <p>支持图片上传、从用户空间添加两种方式发布。支持jpg、jpeg、gif、png格式图片，建议上传尺寸360x360以上、大小1.00M内的图片，上传图片将会自动保存在用户图片空间的默认分类中。</p>
        ...
        <dl>
          ...
          <dd>
            <p>
              <label style="padding-right:8px;">
                <input name="isCode" value="0" checked="checked" type="radio" />
                是</label>
              <label>
                <input name="isCode" value="1"  type="radio" />
               否</label>
            </p>
          </dd>
        </dl>
...
<!--           <dd nc_type="no_spec"> -->
<!--             <p> -->
<!--               <input name="goods_commission_rate" value="" type="text"  class="text" /> -->
...
<!--         </dl> -->
       ...
       <!--  <dl>
     	...
     	<dl>
          <dt><span class="red">*</span>商品品牌：</dt>
          <dd>
        ...
        <dl>
          ...
          <dd>
            <p style="float:left;  clear:both; margin-top:8px;">
              ...
              <label for="whops_seller">供应商承担运费</label>
            </p>
            <p style="float:left;  clear:both; margin-top:8px;">
              <input type="radio" value="0"  name="goods_transfee_charge" id="whops_buyer">
              <label for="whops_buyer">会员承担运费</label>
            </p>
                ...
                <li>
                  ...
                  <div id="Postage" style="display:none">
                    <div class="freight-template">
                      ...
                      <input onclick="window.open('${base}/transport/index')" type="button" value="查看我的运费模板" class="select-templ" id="postageButton">
                    </div>
                  </div>
                </li>
                <!-- <li>
                  <input id="isApplyPostage_false" name="isApplyPostage" class="radio" type="radio" checked="" value="0">
                  <label for="isApplyPostage_false">平邮：</label>
                  <input id="py_price" class="w50 text" nc_type='transport' type="text" value="" name="py_price">
                  元                  
                  <label class="ml10">快递：</label>
                  <input id="kd_price" class="w50 text" nc_type='transport' type="text" value="" name="kd_price">
                  元                  
                  <label class="ml10">EMS：</label>
        ...
        <dl>
          ...
          <dd>
            ...
            <p class="mt5">
              ...
              <input onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" disabled="disabled" class="txt" type="text" value="" id="time_to" name="endTime" style="width: 250px;height: 18px;"/>
            </p>
            <p class="mt5">
              <label>
...
$(function(){
	$("#sub").click(function(){
		if($('#goods_form').valid()){
			...
			//佣金比例
// 			var goodsCommissionRate = "";
// 			goodsCommissionRate = $("[name=goods_commission_rate]").val();
...
//					"goodsStorePrice": goodsStorePrice,//商品供应商价格
//					"goodsStorePriceInterval": goodsStorePriceInterval,//区间价格
 					"goodsMarketPrice": goodsMarketPrice,//商品商家价格范围
 					"goodsCostPrice": goodsCostPrice,//商品商家价格
...
// 					"goodsCommissionRate":goodsCommissionRate,//付款比例
					"goodsTransfeeCharge": goodsTransfeeCharge,//商品运费承担方式 默认 0为会员承担 1为供应商承担
...
function ok(goodsShow){
	//如果用户选择上架,则跳到出售中的商品
	if(goodsShow == '1');
	window.location.href='${base}/pro/sale';
	//如果用户选择下架,则跳到仓库中的商品
	if(goodsShow == '0')
	window.location.href='${base}/pro/store';
}
</script>
<script type="text/javascript">
//会员承担运费&运费模板
	        ...
	        var result  = result;
	       	...
	       	if(result.goods_all_num >0){
	            ...
	            {	
	         	...
	         	html+="<div colspan='3' class='checkout'><span class='total-price'>共<i>"+result.goods_all_num+"</i>种商品   金额总计：<em>&yen;"+result.goods_all_price+"</em></span><span class='btn-cart' ><a href='http://192.168.1.220/index.php?act=cart' target='_top' title='结算商品' style='color: #FFF;' >结算商品表中的商品</a></span></div>";
	      }else{
	      	html="<div class='incart-goods'><div class='no-order'><span>您的商品表中暂无商品，赶快选择心爱的商品吧！</span></div><div class='checkout' ><a href='http://192.168.1.220/index.php?act=cart'  title='结算商品' class='btn-cart' >结算购物车中的商品</a></div></div>";
	        }
