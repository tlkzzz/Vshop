...
<div class="iframebox">
    <h3 class="cont-tit">商家统计</h3>
    <ul class="cont-tab">
        <li><a href="${base}/stat/newStore/index">新增商家</a></li>
        <li class="cur"><a href="${base}/stat/storeRank/index">商家排行</a></li>
    </ul>
    ...
    <div class="control-mod">
        <form id="acct-form" method="post" action="" name ="queryListForm">
            ...
            <input type="text" name="storeName" class="text" placeholder="输入商家名称"/>
