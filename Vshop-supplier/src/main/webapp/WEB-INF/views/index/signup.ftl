...
<!--                 <li class="ico02"><i></i>收藏商品关注供应商</li> -->
<!--                 <li class="ico06"><i></i>商品咨询服务评价</li> -->
<!--                 <li class="ico04"><i></i>安全交易诚信无忧</li> -->
<!--                 <div class="clear"></div> -->
<!--             </ol> -->
			<div class="left-pic">
	        	<img src="res/images/login/banner_03.jpg"  border="0" style="max-height: 350px; max-width: 450px;">
	        </div>
            <h3 class="mt20">如果您是本站供应商</h3>
            <div class="nc-login-now mt10">
            	<span class="ml20">我已经注册过帐号，立即<a href="${base}/login" title="" class="register btn">登录</a></span>
            	<span>或是<a class="forget" href="${base}/forget/index">找回密码？</a></span><!-- ${base}/forget/index -->
            </div>
        </div>
        <div class="clear"></div>
    </div>
