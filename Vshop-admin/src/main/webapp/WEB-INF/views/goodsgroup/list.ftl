            ...
            <tbody>
               <#list pager.result as goodsRecommend>
	                <tr class="hover">
	                    ...
	                    <td class="align-center">
	                        <a href="${base}/goodsGroup/forward?reCommendid=${goodsRecommend.reCommendid}" title="编辑" >编辑</a> | <a href="JavaScript:void(0);"  onclick="delgoodsRecommend('${goodsRecommend.reCommendid}')" title="删除" >删除</a>
	                        | <a href="${base}/RelGoodsRecommend/checkrecommendlist?reCommendId=${goodsRecommend.reCommendid}"   title="查看商品" >查看商品</a>
	                        | <a href="JavaScript:void(0);"  onclick="clickreCommend('${goodsRecommend.reCommendid}')" title="关联商品" >关联商品</a>
	                    </td>
	                </tr>
                </#list>
            </tbody>
