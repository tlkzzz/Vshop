...
<div class="wrap">
  <div class="tabmenu">
    <ul class="tab pngFix">
  <li class="active"><a  href="#?act=store&op=store_goods_class">商家分类</a></li></ul>
			    ...
			    function addStoreclass1(stclassid){
			         layer.open({
			            ...
			            yes: function (index) {
			                ...
			                if(""==stcName){
			                	layer.getChildFrame('#vat_stcName').html('商家分类名不能为空');
			                	return false;
			                }
							if(""==stcSort){
								layer.getChildFrame('#vat_stcSort').html('商家排序不能为空');
								return false;
			                }
