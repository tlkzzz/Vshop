...
<img src="${base}/res/html5/images/back.png" width="25" height="25" /></a>重置密码
<a class="menu home" href="${base}/m/index/index"><img src="${base}/res/html5/images/home.png" width="25" height="25" />
</a></div>
-->
	<div class="header">
...
<div class="phone_main">
    ...
    <div class="phone_login">
    	<ul>
        	...
        	<li class="yz"></li>
        	<li class="yzm">
	          <input type="text" name="validCode" id="validCode" placeholder="请输入动态验证码" style="width:42%;"/>
	          <input type="button" id="validBtn" value="免费获取" style="width:42%; text-align:center;">
