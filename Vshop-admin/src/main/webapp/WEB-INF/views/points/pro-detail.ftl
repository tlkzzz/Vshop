  ...
  <div class="item-publish">
    <form method="post" id="points_goods_form" action="javascript:void(0);">
      <div class="goods-attribute" style="width: 98%;">
        ...
        <dl>
          <dt><a href="${frontServer}/product/detail?id=${goods.goodsId}" target="_blank">查看该商品的详情</a></dt>
        </dl>
        <dl>
          <dt class="required"><span class="red">*</span>积分商品名称：</dt>
          <dd>
            <p>
              <input name="pointsGoodsName" type="text" class="text w400" title="" value="${goods.goodsName}"/>
            <p>
		...
		<dl>
          ...
          <dd nc_type="no_spec">
            <p>
              <input name="pointsGoodsSubtitle" type="text"  class="text w500" value="${goods.goodsSubtitle}" />
            </p>
        ...
        <dl>
          ...
          <dd nc_type="no_spec">
            <p>
              <input name="pointsNums" type="text"  class="text" />
            </p>
          </dd>
        </dl>
       ...
       <dl>
          ...
          <dd  nc_type="no_spec">
            <p>
              <input name="pointsGoodsStorage" type="text"  class="text"/>
            </p>
            <p class="hint">库存必须小于${goodsSpec.specGoodsStorage}</p>
          </dd>
       </dl>
        ...
        <dl>
          ...
          <dd nc_type="no_spec">
            <p>
              <input name="exchangeCount" type="text"  class="text" />
            </p>
          </dd>
        </dl>
        ...
        <dl>
          ...
          <dd nc_type="no_spec">
            <p>
              <input name="memberGrade" type="text"  class="text" />
            </p>
          </dd>
        </dl>
        ...
        <dl>
          ...
          <dd>
            <p>
              <textarea id="points_goods_body" name="pointsGoodsBody" style="width:100%;height:400px;visibility:hidden;" value="${goods.goodsBody}"></textarea>
	            </p>
          </dd>
        </dl>
	...
	$("#sub").click(function(){
		if($('#points_goods_form').valid()){
			...
			var args = {
					...
					"goodsSpecId":"${goodsSpec.goodsSpecId}",
...
function ok(show){
	...
	window.location.href='${base}/points/sell/list';
}
</script>