...
<div class="layout">
    ...
    <div class="wrap-shadow">
        <div class="wrap-all">
            <div class="chart">
                <div class="pos_x1 bg_a1" title="请选择${supplierName}分类"></div>
                <div class="pos_x2 bg_b1" title="填写${supplierName}信息"></div>
            ...
            <div class="grade-shop">
                <table>
                    ...
                    <tr style="border-bottom:none">
                        <th class="w490">恭喜您，${supplierName}注册完成！
