...
<body>
<div class="user_bar" style="text-align:center;color:#fff;"><a class="back" href="${base}/m/authc/buyer/serviceCenter"><img src="${base}/res/html5/images/back.png" width="30" height="30" /></a><span style="margin-right:6%;	">修改密码</span></div>
