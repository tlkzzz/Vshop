				...
				<div class="goods-attribute">
					...
					<dl>
						...
						<dd id="gcategory">
							...
							<!--  <a	class="edit_gcategory ncu-btn1 ml10" href="${base}/pro/sell">
								<span>编辑</span>
							</a>  -->
							<input type="text" id="cate_id" name="cate_id" value="${gcId}"
					...
					<dl>
						...
						<dd>
							<p>
								...
								<#if goods.goodsForm==1> <input name="goods_form" value="1" checked="checked" type="radio" disabled="disabled"/> 全新 
								<#else> <input	name="goods_form" value="1" type="radio" disabled="disabled"/> 全新
								 </#if>
								</label> 
								<label> 
									<#if goods.goodsForm==2> 
										<input name="goods_form" value="2" checked="checked" type="radio" disabled="disabled" />二手
									 <#else>
										<input name="goods_form" value="2" type="radio" disabled="disabled" />
									二手 
									</#if>
								</label>
							</p>
					...
					<dl>
						...
						<dd>
							<p>
								<input name="goods_name" type="text" class="text w400" title="" value="${goods.goodsName}" disabled="disabled" />
							<p>
					...
					<dl>
						...
						<dd nc_type="no_spec">
							<p>
								<input name="goods_subtitle" value="${goods.goodsSubtitle}" type="text" class="text w500" disabled="disabled" />
							</p>
										...
										<li>
											<span nctype="input_checkbox" class="checkbox">
												...
												<#if specMap??>
												 ...
												 </#if> groupId="group_${sps_index}" name="specCheckBox" value="${svl.spValueId}" spValueName="${svl.spValueName}" class="sp_val" spFormat="${sps.spFormat}" >
										</span>
										  <#if sps.spFormat==1>
											 <span class="img">
											 <img src="${imgServer}/${svl.spValueImage}" style="height: 17px; width: 17px;"></span> 
										 </#if> 
									...
									<tr style="display: none;" nctype="file_tr"
										...
										<td><span class="img">
										 <img
												...
												style="height: 17px; width: 17px;" disabled="disabled">
										...
										<img class="spec-img" disabled="disabled"
								...
								<ul id="menu" class="menu">
									<li class="active" id="li_1"><a href="javascript:void(0);" 
										style="background: #3366CC; color: #fff; line-height: 22px; height: 22px; padding: 0 11px; position: relative; margin-right: 20px;">
											...
											onChange="ajaxTypeImageUploads('myBlogImage1','photo')" disabled="disabled"
									...
									<div class="standard">
											...
											<ul
												...
												<!-- <a href='javascript:void(0)'
													imageSrc='${imgSrc}' name='deletePhoto' disabled="disabled"> 删除</a></li> -->
													 </#list>
												</#if>
											</ul>
					...
					<dl>
						...
						<dd>
							<div class="attr">
								...
								${gas.attrName} 
								<select attrId="${gas.attrId}" disabled="disabled"
					...
					<dl>
						...
						<dd>
							<p>
								<textarea id="goods_body" name="goods_body" disabled="disabled"
              	...
              	${goods.goodsBody}
									...
									<li><input id="isApplyPostage_true" name="isApplyPostage"
										...
										<div id="Postage" style="display: none">
											<div class="freight-template">
												<#if transport??> ${transport.title} </#if> <input disabled="disabled"
						...
						<dd>
							<p>
								<label style="padding-right: 8px;"> <input
									name="goods_commend" value="1"  type="radio"  disabled="disabled"
					...
					<!-- <div class="ncu-form-style tc mb30">
						<input type="button" class="submit" value="提交" id="sub" disabled="disabled"/>
					</div> -->
				</div>
			</form>
		</div>
			...
			for(var l = 0; l < valueNames.length; l++){
				...
				for(var e = 0; e < skuTrArr.length; e++){
					if(skuTrArr[e].id == vaId){
						...
						str+
		    			'<td><input class="text" name="price" type="text" disabled="disabled" value="'+skuTrArr[e].price+'"/></td>'+
		    			'<td><input class="text" name="sku" type="text" disabled="disabled" value="'+skuTrArr[e].sku+'"/></td>'+
		    			'<td><input class="text" name="huohao" type="text" disabled="disabled" value="'+skuTrArr[e].huohao+'"/></td>'+
	    				'</tr>';
					}
				}
				if(flg){
					var tr = '<tr name="skuDo" spId='+arr[s].spId+' spName='+arr[s].spName+' specValueName='+arr[s].specValueName+' specValueId="'+arr[s].specValueId+'" value="'+arr[s].specValueId+'">'+
					str+
	    			'<td><input class="text" disabled="disabled" name="price" type="text"/></td>'+
	    			'<td><input class="text" disabled="disabled" name="sku" type="text" value="0"/></td>'+
	    			'<td><input class="text" disabled="disabled" name="huohao" type="text"/></td>'+
    				'</tr>';
				}
