...
<div class="wrap">
  <div class="tabmenu">
    <ul class="tab pngFix">
     <li class="active"><a  href="${base}/storeSetting/storeseting">商家设置</a></li><li class="normal"><a  href="${base}/storeSetting/storeside">幻灯片设置</a></li>
    </ul>
  </div>
  <div class="ncu-form-style">
    <form method="post"  action="" enctype="multipart/form-data" id="my_store_form">
      ...
      <dl>
        <dt>商家等级：</dt>
        <dd>
          <p>系统默认                        <a href="#?act=member_store&op=update_grade" class="ncu-btn2" target="_blank" title="马上升级商家等级">马上升级商家等级</a>
                      </p>
          </dt>
      </dl>
      -->
      ...
      <dl class="setup store-label">
        ...
        <dd>
          ...
          <p class="hint">此处为您的商家logo，将显示在商家Logo栏里；<br/><span style="color:orange;">建议使用宽200像素-高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
        </dd>
      </dl>-->
      ...
      <dl class="setup store-logo">
        ...
        <dd>
          ...
          <p class="hint">此处为您的店铺标志，将显示在店铺信息栏里；<br/><span style="color:orange;">建议使用宽100像素*高100像素内的方型图片；点击下方"提交"按钮后生效。</span></p>
        </dd>
      </dl>
      ...
      <dl class="setup store-top-banner">
        ...
        <dd>
          ...
          <p>
           ...
           <p class="hint">此处为您的店铺条幅，将显示在店铺导航上方的banner位置；<br/><span style="color:orange;">建议使用宽1000*高300像素的图片；点击下方"提交"按钮后生效。（宽度不限制大小，如非必要，尽量使用默认宽度）</span></p>
        </dd>
      </dl>
      <#--
      <dl>
      ...
      <dl class="setup store-storeTheme">
        ...
        <dd>
          ...
          <p class="hint">此处为您的商家标志，将显示在商家信息栏里；<br/><span style="color:orange;">建议使用宽100像素*高100像素内的方型图片；点击下方"提交"按钮后生效。</span></p>
        </dd>
      </dl>
      -->
      <#--
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="hint">用于商家搜索引擎的优化，关键字之间请用英文逗号分隔</p>
        </dd>
      </dl>
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="hint">用于商家搜索引擎的优化，建议120字以内</p>
        </dd>
      </dl>
     	 -->
      <dl class="bottom">
