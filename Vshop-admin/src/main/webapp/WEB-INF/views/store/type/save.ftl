...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>商家分类</h3>
            <ul class="tab-base">
                <li><a href="${base}/store/type/list"><span>管理</span></a></li>
                <li><a href="JavaScript:void(0);" class="current"><span>新增</span></a></li>
            </ul>
        </div>
    </div>
    <div class="fixed-empty"></div>
    <form id="store_class_form" method="post" action="${base}/store/type/saveOrUpdate">
        ...
        $('#store_class_form').validate({
            ...
            rules : {
                name : {
                    required : true,
                    remote   : {
                        url : APP_BASE+'/store/type/validate',
                        type:'post',
                        data:{
                            name : function(){
                                return $('#sc_name').val();
