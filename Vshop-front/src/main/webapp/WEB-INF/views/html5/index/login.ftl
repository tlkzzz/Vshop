	...
	if($("#theForm").valid()){
		...
		$.ajax({
        	...
        	success:function(data) {
            	if(data.success){
            		setTimeout("window.location='${base}/m/index/index'" , 200);
            	}else{
...
<#--
	<div class="phone_hd"><a class="back" href="javascript:history.go(-1);">
		...
		登陆<a class="menu home" href="${base}/m/index/index">
...
<div class="phone_main">
    ...
    <div class="phone_login">
    	<ul>
            ...
            <li><span class="fl"><a href="${base}/m/index/register">免费注册</a></span><span class="fr">
