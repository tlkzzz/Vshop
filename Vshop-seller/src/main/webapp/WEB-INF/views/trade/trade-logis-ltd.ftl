  			...
  			<form method="POST" id='express_form' action="" >
    			...
    			<table class="ncu-table-style" >
      				<thead>
						...
						<tfoot>
					        <tr>
					          <td colspan="5"><a class="submit pngFix ml20 mt10" href="javascript:void(0)"  onclick="saveStoreExtend()"><div align="center"><span>保存</span></div></a></td>
					        </tr>
      					</tfoot>
    				</table>
  				</form>
...
<script type="text/javascript">
	function saveStoreExtend(){
		...
		$.ajax({
           url:'${base}/transport/saveStoreExtend',
           type:'post',
           data : data,
           dataType:'json',
