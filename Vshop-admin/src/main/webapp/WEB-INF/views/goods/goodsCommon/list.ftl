...
<div class="page">
    ...
    <form method="post" name="formSearch" id="formSearch" action="${base}/goods/goodsCommon/list">
        ...
        <table class="tb-type1 noborder search">
            ...
            <tr>
                ...
                <td id="gcategory" colspan="8" style="width:450px">
            ...
            <tr>
                <th><label for="search_store_name">所属商家:</label></th>
                <td>
                ...
                <td><select name="goodsShow">
                    <option value="" <#if gcommon.goodsState == null>selected="selected"</#if>>请选择...</option>
                    <option value="0" <#if gcommon.goodsState == 0>selected="selected"</#if>>下架</option>
                    <option value="1" <#if gcommon.goodsState == 1>selected="selected"</#if>>上架</option>
                    <option value="10" <#if gcommon.goodsState == 10>selected="selected"</#if>>违规（禁售）</option>
                </select></td>
    ...
    <table class="table tb-type2" id="prompt">
        ...
        <tr>
            <td><ul>
                <li>上架,下架，当商品处于非违规下架状态时，前台能浏览该商品，院长可控制商品上、下架状态</li>
            ...
            <#if pager.result??>
	            ...
	            <tr class="hover edit">
	                ...
	                <td class="align-center">
	                    ...
	                    <#if goods.goodsShow==1><p><a href="javascript:void(0);" onclick="goods_lockup(${goods.goodsId});">违规下架</a></p></#if>
	                </td>
	            </tr>
