    ...
    <form method="post" action="${base}/orders/list" name="formSearch" id="formSearch">
        ...
        <table class="tb-type1 noborder search">
            ...
            <tr>
                ...
                <td><input class="txt date" type="text"  id="query_start_time" name="searchStartTime" value="${order.startTimeStr}"/>
                    <label for="query_start_time">~</label>
                    <input class="txt date" type="text" id="query_end_time" name="searchEndTime" value="${order.endTimeStr}"/></td>
                <th>会员</th>
