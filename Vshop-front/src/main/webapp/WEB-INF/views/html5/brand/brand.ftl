			...
			<#list brandList as brand>
		       	<li >
			       	<a href="${base}/m/goods/goodslist?searchType=BrandIdSearch&keyword=${brand.brandId}">
				       	<span class="lg">
				       		<img src=<#if brand.brandPic!=''>"${imgServer}${brand.brandPic}"<#else>"${base}/res/images/common/default_goods_image.gif_small.gif"</#if> width="142" height="66" />
				       	</span>
