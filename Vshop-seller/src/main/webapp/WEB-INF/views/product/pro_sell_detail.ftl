      ...
      <div class="goods-attribute">
        ...
        <dl>
          ...
          <dd nc_type="no_spec">
            ...
            <p class="hint">商品价格必须是0.01~1000000之间的数字</br>若启用了库存配置，请在下方商品库存区域进行管理</br>商品规格库存表中如有价格差异，商城价格显示为价格区间形式</p>
          </dd>
        </dl>
        <#if specs??>
	        <#list specs as sps>
       ...
       <dl>
          ...
          <dd  nc_type="no_spec">
            ...
            <p class="hint">商铺库存数量必须为1~1000000000之间的整数</br>若启用了库存配置，则系统自动计算商品的总数，此处无需商城填写</p>
          </dd>
       </dl>
        <dl>
          ...
          <dd nc_type="no_spec">
            ...
            <p class="hint">商品货号是指商城个人管理商品的编号，会员不可见</br>最多可输入20个字符，支持输入中文、字母、数字、_、/、-和小数点</p>
          </dd>
        </dl>
       ...
       <!--  <dl>
        ...
        <dl>
          ...
          <dd>
            <p style="float:left;  clear:both; margin-top:8px;">
              ...
              <label for="whops_seller">商城承担运费</label>
            </p>
            <p style="float:left;  clear:both; margin-top:8px;">
        ...
        <dl>
          ...
          <dd>
            ...
            <p class="hint">商品可以从属于商城的多个分类之下,</br>商城分类可以由 "用户中心 -> 商城 -> 商品管理 -> 分类管理" 中自定义</p>
          </dd>
        </dl>
        <dl>
          <dt>商品发布：</dt>
	...
	$("#sub").click(function(){
		if($('#goods_form').valid()){
			...
			var args = {
					...
					"goodsStorePrice": goodsStorePrice,//商品商城价格
					...
					"goodsTransfeeCharge": goodsTransfeeCharge,//商品运费承担方式 默认 0为会员承担 1为商城承担
					"StoreClassId": StoreClassId,//商城自定义分类id
