...
<script type="text/javascript" src="${base}/res/easymob-webim-SDK1.0/jquery-1.11.1.js"></script>
<script type="text/javascript" src="${base}/res/easymob-webim-SDK1.0/strophe-custom-2.0.0.js"></script>
<script type="text/javascript" src="${base}/res/easymob-webim-SDK1.0/json2.js"></script>
<script type="text/javascript" src="${base}/res/easymob-webim-SDK1.0/easemob.im-1.0.5.js"></script>
<script type="text/javascript" src="${base}/res/easymob-webim-SDK1.0/bootstrap.js"></script>
<link rel="stylesheet" type="text/css" href="${base}/res/easymob-webim-SDK1.0/css/webim.css" />
<link rel="stylesheet" type="text/css" href="${base}/res/easymob-webim-SDK1.0/css/bootstrap.css" />
<script type="text/javascript">
	...
	// 接收人账号名
	var curChatUserId = 'kviuff';
	$('#addfridentId').val(curChatUserId);
	var conn = null;
	// 群组id
	var curRoomId = null;
	...
	var handleError = function(e) {
		if (curUserId == null) {
			...
			if (e.type == EASEMOB_IM_CONNCTION_SERVER_CLOSE_ERROR) {
				...
				if(msg.indexOf("user not found") > 0){ // 如果用户不存在环信用户库里需要注册一次，再重新登
					customRegister(e.userId, e.pwd);
				}
				//alert(msg);
			}
		}
	...
	/**
	 *用于用户咨询时如果环信没有该用户需要注册进去然后再次登录
	 */
	var customRegister = function (userId, pwd){
		$("#regist_username").val(userId);
		$("#regist_password").val(pwd);
		$("#regist_nickname").val(userId);
		regist();
		login();
	}
</script>
...
<body>
			...
			<table>
				<tr>
					<td width="65%">
						...
						<input type="text" name="username" value="${curUserId}" id="username" tabindex="1" />
						<label for="password">密码:</label> 
						<input type="password" value="${password}" name="password" id="password" tabindex="2" /></td>
				</tr>
			</table>
		</div>
				...
				<table>
					<tr>
						<td width="65%">
							...
							<label>昵称:</label> 
							<input type="text" value="" id="regist_nickname" tabindex="3" /></td>
					</tr>
				</table>
			</div>
		</div>
	...
	<div id="waitLoginmodal" class="modal hide fade" data-backdrop="static">
		<img src="${base}/res/easymob-webim-SDK1.0/img/waitting.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正在努力加载中...</img>
	</div>
	<div class="content" id="content" style="display: none">
		<div class="leftcontact" id="leftcontact">
			<div id="headerimg" class="leftheader">
				<span> <img src="${base}/res/easymob-webim-SDK1.0/img/head/header2.jpg" alt="logo"
		...
		<div class="chatRight">
				...
				<div class="chat01_title">
					<ul class="talkTo">
						...
						<li id="recycle" style="float: right;"><img
							src="${base}/res/easymob-webim-SDK1.0/img/recycle.png" onclick="clearCurrentChat();"
							style="margin-right: 15px; cursor: hand; width: 18px;" title="清屏" /></li>
						<li id="roomInfo" style="float: right;"><img
							id="roomMemberImg"
							src="${base}/res/easymob-webim-SDK1.0/img/head/find_more_friend_addfriend_icon.png"
			...
			<div class="chat02">
				...
				<div class="chat02_bar">
					<ul>
						<li style="right: 5px; top: 5px;"><img src="${base}/res/easymob-webim-SDK1.0/img/send_btn.jpg"
							onclick="sendText()" /></li>
					</ul>
				</div>
