...
<div class="wrap">
  <div class="tabmenu">
    <ul class="tab pngFix">
  <li class="active"><a  href="${base}/other/storegbuy">购买记录</a></li><li class="normal"><a  href="${base}/other/goldlog">金币日志</a></li></ul>
    <div class="text-intro" style=" right:100px;">您当前拥有 0 枚金币</div>
    <a href="#" class="ncu-btn3" nc_type="dialog" dialog_title="购买金币" dialog_id="gold_buy" dialog_width="480" uri="#?act=store_gbuy&op=add">购买金币</a></div>
