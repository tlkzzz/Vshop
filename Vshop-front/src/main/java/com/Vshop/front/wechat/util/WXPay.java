 ...
 */
public class WXPay {
	public static String createPackageValue(String appid, String appKey, String prepay_id,String openid)  {
	...
	public static SortedMap createPackageObj(String appid, String appKey, String prepay_id,String openid)  {
		SortedMap<String, String> nativeObj = new TreeMap<String, String>();
		nativeObj.put("appId", appid);
		nativeObj.put("timeStamp", OrderUtil.GetTimestamp());
		Random random = new Random();
