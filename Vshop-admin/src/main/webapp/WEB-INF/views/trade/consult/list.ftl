        ...
        <table class="table tb-type2">
            ...
            <#list pager.result as c>
                <tr class="space">
                    ...
                    <th><strong>商家名称:</strong>&nbsp;<a href="${frontServer}/store/shop?storeId=${c.storeId}" target="_blank" class="normal" >${c.storeName}</a></th>
                ...
                <tr>
                    <td colspan="12"><fieldset class="w mtn">
                        <legend><span><strong>咨询人:</strong>&nbsp;
                            ...
                            咨询时间:</strong>&nbsp;${c.consultAddtime?string("yyyy-MM-dd HH:mm:ss")}
                        </span></legend>
                        <div class="formelement" id="hutia_${c_index}">${c.consultContent}</div>
                    </fieldset>
                        <fieldset class="d mtm mbw">
                            <legend><strong>院长回复:</strong></legend>
