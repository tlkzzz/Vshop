...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>商品</h3>
            <ul class="tab-base">
                <li><a href="JavaScript:void(0);" class="current"><span>上架商品</span></a></li>
        ...
        <table class="table tb-type2">
            ...
            <#if pager.result??>
	            ...
	            <tr class="hover edit">
	                ...
	                <td class="align-center">
                       	<p><a href="javascript:void(0);" onClick="combinationDialog('${goods.goodsId}','${goods.storeId}')"><nobr>修改组合商品</nobr></a></p>
	                    ...
	                    <p><a href="javascript:void(0);" onClick="relActivityDialog('${goods.goodsId}','${goods.storeId}')"><nobr>关联活动</nobr></a></p>
	                </td>
	            </tr>
 ...
 */
  ...
  *  商品关联活动
  */
  function relActivityDialog(goodsId,storeId) {
	  layer.open({
          type: 2,
          move: false,
          shade: false,
          title: '',
          content:['${base}/goods/activityrel/list?goodsId=' + goodsId + "&storeId=" + storeId, 'no'],
          area: ['800px', '500px'],
          btns: 2,
          btn: ['确定'],
          btn1: function (index) {
