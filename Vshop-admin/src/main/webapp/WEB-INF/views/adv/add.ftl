        ...
        <tbody>
	      ...
	      <tr>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" class="txt Wdate" value="${adv.startDate}" name="startTime" id="startTime" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"></td>
	           <td class="vatop tips"></td>
	        </tr>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
	            	<input type="text" class="txt Wdate"  name="endTime" id="endTime" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" >
	            </td>
	            <td class="vatop tips"></td>
	        </tr>
