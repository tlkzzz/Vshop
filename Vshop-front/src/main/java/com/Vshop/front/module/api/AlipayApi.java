...
import com.Vshop.front.pay.mobile.alipay.util.SignUtils;
...
public class AlipayApi extends BaseApi {
	 ...
	 * @return
	 */
	@RequestMapping("alipaySignOrderInfo")
	@ResponseBody
	public JSONObject toalipay(
		...
		try {
			...
			if(ordert != null) {
				...
				jsonObj.put("data" , SignUtils.signOrderInfo(ordert , false));// 对订单进行签名
			} else {
				jsonObj.put("result", 0);
