...
<!-- 						            </a> -->
					        	...
					        	<p>
					        		<#if order.refundLog??>
					        			<#if order.refundLog.refundState == 1>
					        				<a href="javascript:void(0)" onclick="refund('${order.refundLog.logId}')" >退款</a>
					        			</#if>
					        		</#if>
					        		<#if order.returnOrder??>
					        			<#if order.returnOrder.returnState == 1>
					        				<a href="javascript:void(0)" onclick="returnOrder('${order.returnOrder.returnId}')" >退货</a>
					        			</#if>
					        		</#if>
					        	</p>
					        </td>
					        ...
					        <td class="bdl bdr" rowspan="${rowsize}">
				                ...
				                <#elseif order.orderState==30>
				                	<p><span style="color:#F30">供应商已发货</span><br/></p>
