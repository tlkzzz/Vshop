...
<form id="store_class_form" name="floorForm" method="post" action="${base}/website/index/save">
    <table class="table tb-type2">
        ...
        <tr class="noborder">
        	<input type="hidden" name="ggImg" id="ggImg" value="${vo.ggImg}"/>
        	<input type="hidden" name="ggUrl" id="ggUrl" value="${vo.ggUrl}"/>
            <td class="vatop rowform">
	            <#if vo.ggImg??>
	            	<img id="floorggImg" width="210px" src="${imgServer}${vo.ggImg }"/>
	            <#else>
...
<div id="upload_floorggBanner_dialog" style="display:none;">
    ...
    <table id="upload_tit_type_pic" class="table tb-type2">
        ...
        <tr class="noborder">
            ...
            <input type='button' name='button' id='button1' value='' class='type-file-button' />
            <input name="pic" id="pic3" type="file" class="type-file-file" size="30">
            </span></td>
            <td class="vatop tips">建议上传210×40像素GIF\JPG\PNG格式图片。</td>
        </tr>
        </tbody>
