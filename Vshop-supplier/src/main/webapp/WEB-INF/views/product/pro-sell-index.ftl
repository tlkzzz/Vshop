...
<div class="layout">
    ...
    <!--S 搜索商品-->
  <!-- <div class="wp_search_com">
	<span class="icon"></span>
	<span class="txt">分类搜索：  
    	<input value="请输入商品名称或分类属性名称" id="searchKey" maxlength="22" type="text" class="text">
  	</span>
  	<a class="btn_search" href="JavaScript:void(0);" id="searchBtn">搜索</a>
  </div> -->
    ...
    <div class="wrapper_search">
        ...
        <div class="wp_sort" style="height:280px;position:relative;">
            ...
            <div class="sort_selector">
                <div class="sort_title">
                    ...
                    <input class="select_box" id="commSelect" value="请选择" type="text" >
                </div>
            </div> -->
            <!-- <div class="select_list" id="commListArea" style="cursor: pointer; height: 280; overflow: auto; display: none;">
                <ul>
                    <li nc_type="1659|30|0">
	                    <span class="title">美食特产</span>
	                    <a href="JavaScript:void(0);" title="删除" class="del_unavailable"></a>
                    </li>
                </ul>
            </div> -->
            <div id="class_div" class="wp_sort_block" style="top:-5px;">
                <div class="sort_list">
    ...
    <form method="get" action="${base}/pro/selldetail">
 ...
 // 分类选择
    ...
    function tonextClass(id){
    	...
    	/* $('#t_id').val(valarray[2]); */
    	$('#dataLoading').show();
    	$.getJSON('${base}/pro/findChildClass?id='+valarray[0],
    		function(data){
...
//     					}
    ...
    $('#commoditya > a').unbind().click(function(){
    	$.getJSON('${base}/pro/findChildClass?id='+$('#class_id').val(), function(data){
    		if (data.result != null && data.result != "null" && data.result != ""){
