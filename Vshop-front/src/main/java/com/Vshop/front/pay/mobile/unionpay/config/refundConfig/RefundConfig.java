 ...
 * 
 */
package com.Vshop.front.pay.mobile.unionpay.config.refundConfig;
...
public class RefundConfig extends UnionpayBaseConfig {
	...
	private static RefundConfig loadConfig() {
		// 读取参数
		ResourceBundle rb = ResourceBundle.getBundle("com.Vshop.pinche.pay.mobile.unionpay.config.refundConfig.refundConfig");
