    ...
    <form id="class_form" method="post" action="${base}/coupon/update">
        ...
        <table class="table tb-type2">
            <tbody>
	            ...
	            <tr>
	                <td class="required" colspan="2"><label class="validation" for="classShow">商家名称：</label></td>
	            </tr>
	            <tr class="noborder">
	            ...
	            <tr>
	                <td class="required" colspan="2"><label class="validation" for="classShow">赞助商：</label></td>
	            </tr>
	            <tr class="noborder">
	                <td class="vatop tips">${sponsor.name}</td>
	            </tr>
	            
	            <tr>
	                <td class="required" colspan="2"><label class="validation" for="classShow">绑定商品：</label></td>
	            </tr>
	            <tr class="noborder">
	                <td class="vatop tips"><#list goodsList as goods>${goods.goodsName}<#if goods_has_next>，</#if></#list></td>
	            </tr>
