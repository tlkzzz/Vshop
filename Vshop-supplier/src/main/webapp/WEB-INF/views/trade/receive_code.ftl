...
<div class="layout">
    <div class="sidebar"></div>
 	<div class="right-content">
        <div class="path">
      		<div>
      			<a href="#">供应商中心</a><span>&gt;</span><a href="#"/>收码</a><span>&gt;</span>待收码订单
            </div>
    	</div>
        <div class="main">
			<div class="wrap">
  				<div class="tabmenu">
    				<ul class="tab pngFix">
    					<li class="active">
  							<a href="${base}/transport/receivecode?orderState=40">待收码订单</a>
  						</li>
  					</ul>
  				</div>
  				<form method="post" action="${base}/transport/receivecode" target="_self" id="queryForm">
		          								...
		          								<#if orderGoods_index == 0>
			                						<td class="bdl bdr order-info w400" rowspan="${orderGoods?size}">
			                							<dl>
			          									...
			          									<dl>
			                                    			<dt>&nbsp;</dt>
			            									<dd><a href="${base}/transport/receivecode_deliver_update?orderId=${order.orderId}" class="ncu-btn2 mr10 fr">查看订单信息</a></dd>
			                      						</dl>
			                      					</td>
		                      					</#if>
		              						</tr>
