            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        //排序
                        src += " <span title='可编辑下级分类排序' ajax_branch='goods_class_sort' datatype='number' fieldid='" + data[i].gcId + "' fieldname='gc_sort' nc_type='inline_edit' class='editable tooltip'>" + data[i].gcSort + "</span></td>";
                        //名称
